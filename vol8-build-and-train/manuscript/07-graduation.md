...
> [目次](../TOC.md) ・ [← 前の章](06-evaluation.md) ・ [次の章 →](08-epilogue-gpt-bert.md)
...
毎巻の巻末で繰り返してきた儀式——巻頭の引用の前にもう一度立ち、読めるようになったことを確認する——は、これで8回目です。そして今回は終わりません。第1巻の序章は、こう約束していました。
...
第1巻の序章で、私たちはこの式の前に立ち「おそらく、何ひとつ読めないはずです」と言われました。$Q$ とは何か、肩の $T$ は何か、なぜ $\sqrt{d_k}$ で割るのか——あのときは、読めない箇所を指さすことすらできませんでした。第1巻終章で shape が、第4巻で softmax と $\sqrt{d_k}$ が、第6巻で Q・K・V の意味が埋まり、第7巻で実装し、この巻で訓練しました。8巻かけて、のべ6回この式の前に立っています。
...
第1巻の序章で論文読解マップを開いたとき、ほとんどの行が「まだ」でした。各巻で印を付けてきたその地図が、いま最終形になりました。これがあなたの**卒業証書**です。
...
第7巻の終章では、Section 3・4 の対応表を「卒業証書の半分」と呼びました。なぜ半分か——組み立てておらず、訓練していないからです。この巻で、その2つの溝を埋めました。表の下半分、Section 5・6 の行に並ぶコードは、読んだだけのものがひとつもありません。**動かして、学習させて、測ったもの**だけです。

この証書の効力は、「Transformer のすべてを知っている」証明ではなく、「この論文のどの行についても、**対応する自分の理解と自分のコードの住所が言える**」証明です。後者の方がずっと強いと私たちは考えています。知識は古びますが、住所の引き方は古びません。

## 7.3 旅程 — 通った道と、通らなかった道

卒業式なので、入学の日を思い出しましょう。すべては1行から始まりました。

```python
Y = X @ W + b
```

第1巻は、この1行の部品——ベクトル、内積、行列積、転置——を揃える巻でした。第2巻で、$W$ を機械が自分で見つける仕組みの土台として微分と勾配降下法を手に入れました。第3巻で「モデル = パラメータ付き関数、学習 = 損失最小化」という世界観と4拍子の訓練ループを確立し、巻末で分類問題に敗北しました。第4巻がその敗北に答えて cross-entropy を導出し、ついでに softmax と $\sqrt{d_k}$ を式(1)に埋めました。第5巻で backprop を理解して autograd を自作し、residual・layer norm・dropout という配管を揃えました。第6巻で言語をベクトルにし、RNN の痛みを体感して「attention だけでいい」というタイトルの意味を理解しました。第7巻で論文の Section 3・4 を逐行精読し、全部品を実装しました。そしてこの第8巻で、組み立て、訓練し、評価しました。

`X @ W + b` から Transformer まで。振り返れば一本道ですが、それは偶然ではありません。**一本道になるように、最初から測地線を引いてあった**からです。

そして卒業式では、通った道と同じくらい、**通らなかった道**を誇るべきです。

このシリーズには、固有値も固有ベクトルも、行列式も逆行列も(第3巻で名前だけ登場し、通らないと宣言されました)、ベイズ統計も、SVM も、決定木も、k-means も出てきませんでした。CNN は Background の「捨てられた側」としてしか出てこず、強化学習もです。どれも機械学習の正規の教養であり、素晴らしい道具です。

それらを省いたのは、知らなくてよいからではなく、**この論文への最短測地線の上にないから**です。第1巻の序章はこう宣言していました——「この本は、機械学習の教科書ではありません」「網羅性はこの本の美徳ではない」。いま、その宣言を検証できます。固有値を知らないことが原因で立ち往生した章が、1つでもあったでしょうか。ありませんでした。省いたものはすべて「いつか必要になるかもしれない」だけのもので、その必要は最後まで来ませんでした。

これは「学ばなくてよかった」ではなく、**「いつ学んでもよくなった」**という話です。あなたはいま、1本の論文を完全に読み切るとはどういうことかを知っています。次にベイズが必要になったら、そのときのあなたは、ベイズへの測地線を自分で引けるはずです。通らなかった道は消えていません。地図の上で、出発点だけが変わりました。

需要駆動の順序も、最後まで守られました。確率より先に機械学習をやったのは cross-entropy に困ってから確率を出すため、PyTorch を第8巻まで我慢したのは自作スタックでは訓練が終わらないと体感してから出すためでした。8巻を通して、**困る前に出てきた道具は、ひとつもなかった**はずです。新しい道具が出てきたとき、あなたはいつも、それが解決する痛みを先に知っていました。

## 7.4 タイトルの回収 — Fable Is All You Need

最後に、この本の表紙の話をします。

"Fable Is All You Need" が "Attention Is All You Need" のパロディであることは、第1巻の序文からの公然の仕掛けでした。本題は、もうひとつの意味です。**fable は、寓話という意味です。**

寓話とは、小さな具体的な物語に教訓を畳み込んだものです。ウサギとカメの話は速さの話ではなく、歩みを止めないことの話です。では、この8巻はどんな寓話だったのでしょうか。

筋は、こうでした。15ページの論文があり、最初の1ページすら読めない読者がいた。読者は論文を「読めない箇所の集まり」に分解し、1つ選んでは、それを読むための道具を1つ手に入れ、地図に印を付けた。それを繰り返した。8巻後、読めない箇所はなくなっていた——。
