...
![図1.1](../figures/ch01-param-breakdown.png)

図1.1: 縮小版(N=6, $d_{model}$=64, $d_{ff}$=256, h=8, 語彙1,000)のパラメータ 759,808 個の内訳。decoder が最大の割合を占めるのは、1層あたりの attention が cross-attention のぶん encoder より1個多いため。
