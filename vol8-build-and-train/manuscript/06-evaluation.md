...
![図6.1](../figures/ch06-bleu-ngram.png)

図6.1: rug の例の modified n-gram precision。外した単語は rug 1個でも、それを含む n-gram がすべて道連れになるため、$n$ が長いほど精度が下がる。4つの精度は幾何平均(点線、$(1/3)^{1/4} \approx 0.760$)にまとめられる。
