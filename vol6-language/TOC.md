...
## [第1章 言語モデル — 次の単語を当てるゲーム](manuscript/01-language-models.md)
...
## [第2章 トークン化 — 文章を記号列に切る](manuscript/02-tokenization.md)
...
## [第3章 埋め込み — トークンをベクトルにする](manuscript/03-embeddings.md)
...
## [第4章 n-gram — 数えるだけの言語モデル](manuscript/04-ngram.md)
...
## [第5章 RNN — 記憶を持つネットワーク](manuscript/05-rnn.md)
...
## [第6章 seq2seq — 翻訳という問題設定](manuscript/06-seq2seq.md)
...
## [第7章 attention — 「全部見ればいい」](manuscript/07-attention.md)
...
## [終章 ラスボス再戦 — Introduction が読める](manuscript/08-boss-rematch.md)
