...
## [序章 装備の点検](manuscript/00-prologue.md)
...
## [第1章 Abstract・Introduction・Background を読む](manuscript/01-intro-background.md)
...
## [第2章 3.1 Encoder and Decoder Stacks — 全体の見取り図](manuscript/02-stacks.md)
...
## [第3章 3.2.1 Scaled Dot-Product Attention — 式(1)の実装](manuscript/03-scaled-dot-product.md)
...
## [第4章 3.2.2 Multi-Head Attention — 視点を増やす](manuscript/04-multi-head.md)
...
## [第5章 3.2.3 — attention の3つの使い方](manuscript/05-three-attentions.md)
...
## [第6章 3.3 FFN・3.4 Embeddings and Softmax](manuscript/06-ffn-embeddings.md)
...
## [第7章 3.5 Positional Encoding — 語順を取り戻す](manuscript/07-positional-encoding.md)
...
## [第8章 Section 4 Why Self-Attention — 比較表を読む](manuscript/08-why-self-attention.md)
...
## [終章 完走確認 — 式番号 ↔ コード行 対応表の完成](manuscript/09-completion.md)
